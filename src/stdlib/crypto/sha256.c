...
static const uint32_t k[64] = {
	...
	0xe49b69c1,0xefbe4786,0x0fc19dc6,0x240ca1cc,0x2de92c6f,0x4a7484aa,0x5cb0a9dc,0x76ca1462,
...
void peel_sha256_transform(PEEL_SHA256_CTX *ctx, const uint8_t data[]) {
...
void peel_sha256_update(PEEL_SHA256_CTX *ctx, const uint8_t data[], size_t len) {
	for (size_t i = 0; i < len; ++i) {
		...
		if (ctx->datalen == 64) {
			peel_sha256_transform(ctx, ctx->data);
